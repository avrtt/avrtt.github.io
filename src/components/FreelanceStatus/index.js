...
var statusEmoji, statusString, statusStringRu, statusExtraDesc, statusExtraDescRu, backgroundColor, color, isArrowVisible, isDateOfStartRespondingVisible
...
const FreelanceStatus = ({ isRussian=false, isHome=false }) => {
	return isRussian ? ( 
		<>
