...
- **Number of base learners** (<Latex text="\(M\)"/>): Usually, the more learners, the lower the variance — up to a point. In practice, 100–1000 trees are common for random forests. 
