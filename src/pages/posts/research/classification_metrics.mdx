...
Оценка качества в задачах классификации и регрессии (ТА ЧАСТЬ, КОТОРАЯ ПРО КЛАССИФИКАЦИЮ)
...
[https://alexanderdyakonov.wordpress.com/2019/05/31/функционалы-качества-в-задаче-бинарн/](https://alexanderdyakonov.wordpress.com/2019/05/31/%D1%84%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D0%BE%D0%BD%D0%B0%D0%BB%D1%8B-%D0%BA%D0%B0%D1%87%D0%B5%D1%81%D1%82%D0%B2%D0%B0-%D0%B2-%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D0%B5-%D0%B1%D0%B8%D0%BD%D0%B0%D1%80%D0%BD/)
Про все метрики и когда их использовать:
...
Обобщение MCC для мультиклассовой классификации:
...
[https://neerc.ifmo.ru/wiki/index.php?title=Оценка_качества_в_задачах_классификации_и_регрессии](https://neerc.ifmo.ru/wiki/index.php?title=%D0%9E%D1%86%D0%B5%D0%BD%D0%BA%D0%B0_%D0%BA%D0%B0%D1%87%D0%B5%D1%81%D1%82%D0%B2%D0%B0_%D0%B2_%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D0%B0%D1%85_%D0%BA%D0%BB%D0%B0%D1%81%D1%81%D0%B8%D1%84%D0%B8%D0%BA%D0%B0%D1%86%D0%B8%D0%B8_%D0%B8_%D1%80%D0%B5%D0%B3%D1%80%D0%B5%D1%81%D1%81%D0%B8%D0%B8)
...
- [Матрицы ошибок для измерения точности, полноты и чувствительности модели](https://towardsdatascience.com/understanding-confusion-matrix-a9ad42dcfd62).
- [F1 оценка](https://towardsdatascience.com/understanding-confusion-matrix-a9ad42dcfd62).
- [Истинно-положительный, истинно-отрицательный, ложно-позитивный и ложно-отрицательный результаты](https://medium.com/datadriveninvestor/confusion-matric-tpr-fpr-fnr-tnr-precision-recall-f1-score-73efa162a25f) (TPR, TNR, FTR, FNR).
- [Ошибки первого и второго рода](https://www.stat.berkeley.edu/~hhuang/STAT141/Lecture-FDR.pdf).
- [Кривые AUC-ROC](https://towardsdatascience.com/understanding-auc-roc-curve-68b2303cc9c5).

Describe the classification metrics you know. Which metrics should be considered in case of class imbalance? (см. ML-канал)
Перевести на ML язык запрос менеджера: "хочу, чтобы модель выявляла почти всех "плохих" заемщиков" + Какие метрики не чувствительны к несбалансированности классов + Как бороться с несбалансированности классов? (см. ML-канал)
...
Precision and recall often trade off against each other — improving one can degrade the other. The <Highlight>F1 score</Highlight> (or **F1** measure) is the **harmonic mean** of precision and recall:
...
In practice, medical professionals, for instance, often examine both sensitivity (<Latex text="\( \mathrm{Recall} \)"/>) and specificity together — these are sometimes called "orthogonal metrics" because they gauge different kinds of errors. In certain contexts, you may also see the "Youden's J statistic," which is
...
<Image alt="Multiclass confusion matrix example" path="" caption="A 3×3 confusion matrix for a three-class classification problem." zoom="false" />
