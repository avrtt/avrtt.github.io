				...
				<AnimationOnScroll offset={300} duration={1.2} animateIn="animate__fadeIn" animateOnce={true}>
					...
					<div className={`${stylesWallets.wallets} desktopOnlySupport`}>
						...
						<div className={stylesWallets.wallet3}>
							...
							<div className={stylesWallets.currencyName}><b>USD</b> &nbsp;(BAKAI BANK)</div>
						</div>
						<div className={stylesWallets.wallet3}>
							...
							<span className={stylesWallets.tooltiptext}>Click to copy</span></div></code>
							<div className={stylesWallets.currencyName}><b>USD</b> &nbsp;(MBANK)</div>
						</div>
						<div className={stylesWallets.wallet3}>
							...
							<span className={stylesWallets.tooltiptext}>Click to copy</span></div></code>
							<div className={stylesWallets.currencyName}><b>EUR</b> &nbsp;(MBANK)</div>
						</div>
						<div className={stylesWallets.wallet3}>
							...
							<span className={stylesWallets.tooltiptext}>Click to copy</span></div></code>
							<div className={stylesWallets.currencyName}><b>RUB</b> &nbsp;(MBANK)</div>
						</div>
						<div className={stylesWallets.wallet3}>
