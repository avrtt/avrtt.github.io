...
- 😍 lightweight DIY things
							...
							<p>I've made "<Link to="/dev/null/">/dev/null</Link>" — a <S>special</S> page of the website just for you! Hope you enjoy it there.</p>
						</div>
					</div>
					<div className="mobileOnlySupport"><br/></div>
				</div>
					...
					<div className="mobileOnlySupport">
						...
						<div class="list" style={{ marginLeft: 0, marginBottom: "1rem" }}>
							<ul>
								...
								<li>🎁 <S><H>Donate</H>: <Link to="/donate">link</Link></S></li>
							</ul>
						</div>
					</div>
				</div>
