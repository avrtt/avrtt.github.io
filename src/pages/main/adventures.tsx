...
import { wordsPerMinuteAdventures } from '../../data/commonVariables';
...
const wordsPerMinute = wordsPerMinuteAdventures;
...
export const Head = () => (
  <SEO 
    title="Adventures - avrtt.blog"
    description="Discover Vladislav Averett's travel experiences, adventures, photo stories, and geographical explorations from countries around the world."
    keywords={["travel blog", "adventure blog", "travel stories", "travel photos", "geo blog", "adventures"]}
    image={""}
    canonicalUrl="https://avrtt.github.io/adventures"
