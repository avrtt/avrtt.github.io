    ...
    <motion.div
		...
		<div className="freelanceBody">
			...
			<Spoiler 
				...
				block2={"В данном списке представлены некоторые мои проекты, связанные с веб-разработкой (исключая вклад в open-source и прочие проприетарные или небольшие проекты)."}
			/>
			<br/>
...
export const Head = () => (
  <SEO 
    title="Проекты: веб-разработка - avrtt.blog"
    description=""
    keywords={[""]}
    image={""}
    canonicalUrl=""
