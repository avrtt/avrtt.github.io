...
const categoryItem = categories.find(item => item.categoryKey === 'machine_learning');
    ...
    <motion.div
		...
		<div className="freelanceBody">
			...
			<Spoiler 
				...
				block2={"В данном списке представлены некоторые мои проекты, связанные с машинным обучением (исключая вклад в open-source и прочие проприетарные или небольшие проекты)."}
			/>
			<br/>
