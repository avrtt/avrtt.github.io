...
const categoryDescDetailed = categories.find(item => item.categoryKey === 'misc').categoryDescDetailed;

projectsFiltered.sort(function (a, b) {
	return b.id - a.id;
  });

const TITLE = 'Misc projects - avrtt.blog'
  ...
  return (
    <motion.div
		...
		<div class={stylesFreelancePages.categorySwitchWrapper}> 
			...
			<Link title="Python projects" class="noselect" className={stylesFreelancePages.categoryButton} to="/freelance/projects/python_apps"><div class="noselect" className={stylesFreelancePages.categoryButton}><img src={PythonAppsIcon} alt="button_icon" width="50%" height="100%" /></div></Link>
		...
		<div class="freelanceBody">
			...
			/>
			<br/>
			<M text="The following list represents some of my highlighted misc projects (excluding open-source contributions and other proprietary or small projects):"/>
