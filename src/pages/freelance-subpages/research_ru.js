...
const categoryDescDetailedRu = categories.find(item => item.categoryKey === 'research').categoryDescDetailedRu;

projectsFiltered.sort(function (a, b) {
	return b.id - a.id;
  });

const TITLE = 'Проекты-исследования - avrtt.blog'
  ...
  return (
    <motion.div
		...
		<div class="freelanceBody">
			...
			/>
			<br/>
			<M text="В данном списке представлены некоторые мои проекты, связанные с исследовательской деятельностью:"/>
