...
const categoryDescDetailedRu = categories.find(item => item.categoryKey === 'data_collection').categoryDescDetailedRu;

projectsFiltered.sort(function (a, b) {
	return b.id - a.id;
  });

const TITLE = 'Проекты: сбор данных - avrtt.blog'

const DataCollectionRu = () => {
...
export default DataCollectionRu;
