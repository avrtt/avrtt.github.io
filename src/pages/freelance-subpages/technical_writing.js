...
const categoryDescDetailed = categories.find(item => item.categoryKey === 'technical_writing').categoryDescDetailed;

projectsFiltered.sort(function (a, b) {
	return b.id - a.id;
  });

const TITLE = 'Technical writing projects - avrtt.blog'
