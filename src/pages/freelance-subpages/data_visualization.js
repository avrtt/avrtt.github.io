...
const categoryDescDetailed = categories.find(item => item.categoryKey === 'data_visualization').categoryDescDetailed;

projectsFiltered.sort(function (a, b) {
	return b.id - a.id;
  });

const TITLE = 'Data visualization projects - avrtt.blog'
