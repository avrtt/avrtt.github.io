    ...
    <motion.div
		...
		<div class="freelanceBody">
			...
			<Spoiler 
				...
				block2={"The following list represents some of my highlighted web development projects (excluding open-source contributions and other proprietary or small projects)."}
			/>
			<br/>
...
export const Head = () => (
  <SEO 
    title="Web development projects - avrtt.blog"
    description=""
    keywords={[""]}
    image={""}
    canonicalUrl=""
