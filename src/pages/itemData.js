...
export const categories = [
	...
	{categoryKey: 'data_analysis', 
		...
		categoryDescDetailed: "Data mining // Big Data // EDA // Market Analysis // ad hoc // Data Cleaning and Preprocessing // data wrangling, handling missing values, scaling, and encoding data // dealing with missing data, removing duplicates, normalizing data, and transforming it into usable formats // business analytics, data-driven decision-making consulting, DS/AI strategy for businesses", 
		categoryDescDetailedRu: '',
	...
	{categoryKey: 'data_collection', 
		...
		categoryDesc: 'Extending company databases with external data for making better business decisions, or creating separate datasets for any needs from any open sources using different scraping techniques, SQL, annotation and labeling', 
		categoryDescRu: '', 
